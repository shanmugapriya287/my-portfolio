...
# Load the data
file_path = '/Users/divya/Downloads/for_python.xlsx'  # Update the file path as needed
...
for activity in activities:
    ...
    model = SVR(kernel='linear', C=1.0, epsilon=0.1)  # can adjust the kernel, C and epsilon parameters
    ...
    # Since SVM doesn't provide feature importances directly, we won't calculate them here
    print(f"Evaluation Metrics for predicting {activity}:")
    print(f"R² Value: {r2}")
